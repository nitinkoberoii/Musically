...
class TestSignUp():
  ...
  def test_signUp(self):
    ...
    self.driver.find_element(By.LINK_TEXT, "Don\'t have an account? Sign up").click()
    self.driver.find_element(By.ID, "email").click()
    self.driver.find_element(By.ID, "email").send_keys("lonewolfindia15@gmail.com")
    self.driver.find_element(By.ID, "password").click()
    self.driver.find_element(By.ID, "password").send_keys("testing@1")
